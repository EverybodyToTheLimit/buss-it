...
let addResultDom = (obj) => {
    ...
    departureTime.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(obj.departureTime, "H:mm");
    let arrivalTime = document.createElement('div')
    arrivalTime.className = "arrival-time"
    arrivalTime.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(obj.arrivalTime, "H:mm");
